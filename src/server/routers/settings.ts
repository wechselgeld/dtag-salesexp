    ...
    getPricingSettings: publicProcedure.query(() => {
        return getCached('systemSettings:pricing', TTL, async () => {
            ...
            return {
                ...
                plus_karte_flex_price: parseFloat(result.plus_karte_flex_price),
                plus_karte_kids_price: parseFloat(result.plus_karte_kids_price),
                plus_karte_activation_fee_normal: parseFloat(result.plus_karte_activation_fee_normal),
                plus_karte_activation_fee_flex: parseFloat(result.plus_karte_activation_fee_flex),
                plus_karte_activation_fee_kids: parseFloat(result.plus_karte_activation_fee_kids),
                plus_karte_promo_free_activation_normal: result.plus_karte_promo_free_activation_normal === 'true',
                plus_karte_promo_free_activation_flex: result.plus_karte_promo_free_activation_flex === 'true',

			...
			<div className="flex justify-between items-center mb-6">
				<div>
					...
					<p className="text-[0.85rem] text-[#999] m-0">
						Verwalten Sie einmalige Gutschriften (z.B. Anschlusspreisbefreiung).
					</p>
				</div>
				<Link
					...
					<tbody>
									...
									<div className="flex items-center justify-end gap-1 opacity-0 group-hover:opacity-100 transition-opacity">
										...
										<button
											onClick={() => {
												if (
													confirm(
														"Möchten Sie diese Gutschrift wirklich löschen?"
													)
												) {
						...
						{credits?.length === 0 && (
							<tr>
								...
								>
									Keine Gutschriften gefunden. Erstellen Sie die erste!
								</td>
							</tr>
						)}
					</tbody>

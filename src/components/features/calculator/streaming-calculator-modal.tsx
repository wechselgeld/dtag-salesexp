...
const MAGENTA_PLANS = [
	{
		...
		includedServiceIds: ["hd-tv", "rtl-prem"]
	},
	{
		id: "mtv-smartstream",
...
export function StreamingCalculatorModal({
	...
	}, [selectedServices, targetPlan, customPrices]);
			...
			{isOpen && (
				<div className="fixed inset-0 z-[9999] flex items-center justify-center p-4 md:p-8">
					...
					<motion.div
						...
						className="relative w-full max-w-7xl bg-white rounded-[2rem] shadow-[0_20px_60px_-15px_rgba(0,0,0,0.1)] border border-[#eaedf0] overflow-hidden flex flex-col max-h-[95vh]"
					>
						{/* Header */}
						...
						{/* Content Area */}
						<div className="flex-1 overflow-y-auto min-h-0 bg-[#fbfcff]">

...
// ⚡ Bolt: O(1) lookup map to eliminate O(N*M) repeated array searches in renders
...
setMounted,
 ...
 settings,
  ...
  const groupedServices = useMemo(() => {
    const groups: Record<
      string,
      { name: string; tiers: typeof STREAMING_SERVICES }
    > = {
};
...
getPrice,
  ...
  return (
    <div
      className={clsx(
        'flex-1 overflow-y-auto min-h-0 bg-[#fbfcff]',
        !isVisible && 'hidden',
      )}
    >
                ...
                <TierSelect
                  ...
                  selectedId={
                    selectedServices.find(
                      (sId) =>
                        STREAMING_SERVICES_BY_ID.get(sId)?.group ===
                        group.groupId,
                    ) || null
                  }
            ...
            <div className="flex flex-col gap-6.5">
              ...
              >
                ...
                <span className="text-[0.8rem] font-bold uppercase tracking-[0.2em] mb-4 border-b pb-2">
                  {paysMore ? 'Monatliche Mehrkosten' : 'Monatliche Ersparnis'}
                </span>
                      ...
                      {coveredValue < (targetPlan?.price || 0) ? (
                        <span>
                          ...
                          <b className="text-white text-extrabold whitespace-nowrap">
                            <AnimatedNumber
                              value={(targetPlan?.price || 0) - coveredValue}
                            />{' '}
                            €
                          </b>{' '}
                          bis zum Wertvorteil
              ...
              <div className="grid grid-cols-2 gap-4">
                ...
                <div className="relative flex flex-col items-center text-center p-3.5 rounded-xl border border-[#10b981]/30 bg-[#10b981]/5 transition-all duration-200">
                  <Info
              ...
              <div className="relative flex flex-col items-center text-center p-4 rounded-xl border border-[#eaedf0] bg-[#f7f8fa] mt-auto">
                ...
                <div className="text-[1.3rem] font-bold text-[#1a1a2e]">
                  <AnimatedNumber value={(targetPlan?.price || 0) / 30} /> €
                </div>
              </div>
            </div>
          </div>

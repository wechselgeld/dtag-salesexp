...
// ⚡ Bolt Optimization: Pre-compute a Map for O(1) lookups instead of repeatedly finding in array
const STREAMING_SERVICES_MAP = new Map(STREAMING_SERVICES.map((s) => [s.id, s]));
